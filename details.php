...
<head>
  ...
  <title>Bank of SLPR - Customer Details</title>
        ...
        echo "
                       ...
                       <br>
                        <table class='table table-bordered' style='text-align: center; font-size: 18px;'>
                            <tr>
                                <th scope='col' style='color: #000;'>Customer ID</th>
                                <td>$customer_id</td>
                            </tr>
                            <tr>
                                <th scope='col' style='color: #000;'>Customer Name</th>
                                <td>$customer_name</td>
                            </tr>
                            <tr>
                                <th scope='col' style='color: #000;'>Customer Email</th>
                                <td>$customer_email</td>
                            </tr>
                            <tr>
                                <th scope='col' style='color: #000;'>Current Balance</th>
