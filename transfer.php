...
<head>
  ...
  <title>Bank of SLPR - Transfer Money</title>
  <style type="text/css">
    .tbl{
      color: #000;
    }
  ...
  <div class="container">
    ...
    if (isset($_GET['customer_id'])) {
                      ...
                      <form action='transfer.php?customer_id=$c_id' method='post' enctype='multipart/form-data'>
                          ...
                          <div class='form-row'>
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='from_acc' class='tbl'>Customer ID</label>
                                  <input type='number' class='form-control' name='from_acc' value='$customer_id' readonly>
                              </div>
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='from_acc_name' class='tbl'>Customer Name</label>
                                  <input type='text' class='form-control' name='from_acc_name' value='$customer_name' readonly>
                              </div>
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='curr_bal' class='tbl'>Current Balance</label>
                                  <input type='number' class='form-control' name='curr_bal' value='$current_balance' readonly>
                              </div>
                          </div>
                          <br>
                          <label for='to' style='font-size: 20px;' class='tbl'>Transfer to</label>
                          <div class='form-row'>
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='to_acc' class='tbl'>Customer Name</label>
                                  <select class='form-control' name='to_acc' required>
                                      <option value='0' class='tbl'>Select Name on Account</option>
                  ";
      ...
      echo "
                              ...
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='transfer_amt' class='tbl'>Transfer Amount</label>
                                  <input type='number' class='form-control' name='transfer_amt' placeholder='Amount' required>
                              </div>
                          </div>
                          <div class='form-row'>
                              <div class='col-lg-4 col-md-8 col-sm-12 mb-3 mx-auto'>
                                  <label for='transfer_msg' class='tbl'>Message for the reciever</label>
